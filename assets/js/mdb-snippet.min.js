!(function (t) {
  ...
  function (r, e, t) {
    ...
    r.exports = function (r) {
      return (
        a(s, r) || (c && a(l, r) ? (s[r] = l[r]) : (s[r] = p("Symbol." + r))),
        s[r]
      );
    };
  },
  ...
  function (r, e, t) {
    ...
    r.exports = function (r, e, t) {
      r &&
        !o((r = t ? r : r.prototype), a) &&
        n(r, a, { configurable: !0, value: e });
    };
  },
  function (r, e, t) {
    "use strict";
        ...
        return (
          ...
          (t = [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                Array.from(this.el.getElementsByTagName("code")).forEach(
                  function (r) {
                    e.data.push({
                      lang: r.dataset.lang,
                      name: r.dataset.name,
                ...
                r.setAttribute("class", "docs-pills border"),
                  ...
                  this.data.forEach(function (r, e) {
                    ...
                    t.setAttribute("class", "nav-item"),
                      ...
                      a.setAttribute(
                        "class",
                        "line-numbers language-".concat(r.lang)
                      ),
    ...
    Array.from(document.getElementsByTagName("mdbsnippet")).forEach(function (
      r
    ) {
      new n(r).init();
    });
  ...
  function (r, e, t) {
    ...
    r.exports = function (r, e) {
      ...
      return (
        o(r) &&
          (("function" == typeof (t = r.constructor) &&
  ...
  function (r, e, t) {
    ...
    r.exports = function (r, e, t) {
      var n,
        ...
        h = 0;
      if (
        (d && (f = m(f, 2 < p ? t : void 0, 2)),
        null == g || (l == Array && y(g)))
      )
        for (o = new l((n = w(s.length))); h < n; h++)
          (u = d ? f(s[h], h) : s[h]), q(o, h, u);
      else
      ...
      if (
        (m &&
          ...
          T !== Object.prototype &&
            ...
            (E ||
              w(u) === T ||
              (q ? q(u, T) : "function" != typeof u[C] && A(u, C, b)),
            x(u, p, !0, !0),
            E && (L[p] = b))),
        o == D &&
          g &&
  ...
  function (r, e, t) {
    ...
    r.exports = function (r, e, t) {
      var n = e + " Iterator";
      return (
        (r.prototype = i(a, { next: c(1, t) })), u(r, n, !1, !0), (s[n] = o), r
      );
    };
  },
  function (r, e, t) {
    ...
    (s[h] = !0),
      (r.exports =
        ...
        function (r, e) {
          ...
          return (
            null !== r
              ? ((n[d] = i(r)), (t = new n()), (n[d] = null), (t[h] = r))
              : (t = m()),
            void 0 === e ? t : c(t, e)
          );
        });
  ...
  function (r, e, t) {
    ...
    r.exports = n
      ...
      : function (r, e) {
          c(r);
          for (var t, n = u(e), o = n.length, a = 0; a < o; )
            i.f(r, (t = n[a++]), e[t]);
          return r;
        };
  },
            ...
            ? r.replace(/&#?[0-9a-zA-Z]+;?/g, function (r) {
                ...
                var e =
                  "x" === r.charAt(2).toLowerCase()
                    ...
                    : parseInt(r.substr(2));
                return isNaN(e) || e < -32768 || 65535 < e
                  ? ""
