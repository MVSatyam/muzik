!(function (t) {
    ...
    (s || f) &&
      (u = function (t) {
        var n,
          ...
          u = this;
        return (
          f && (e = new RegExp("^" + u.source + "$(?!\\s)", i.call(u))),
          s && (n = u.lastIndex),
          (r = c.call(u, t)),
  ...
  function (t, n, e) {
    ...
    t.exports = r
      ...
      : function (t, n) {
          i(t);
          for (var e, r = c(n), a = r.length, u = 0; a > u; )
            o.f(t, (e = r[u++]), n[e]);
          return t;
        };
  },
      ...
      return [
        ...
        function (t, i) {
          ...
          for (var b, w = "", S = 0, $ = 0; $ < m.length; $++) {
            ...
            for (
              var O = String(x[0]),
                j = l(p(a(x.index), d.length), 0),
                k = [],
                C = 1;
              C < x.length;
              C++
            )
              k.push(void 0 === (b = x[C]) ? b : String(b));
            var I = x.groups;
            if (h) {
  ...
  function (t, n, e) {
    ...
    var r = e(3),
      o = e(23).filter;
    r(
      { target: "Array", proto: !0, forced: !e(44)("filter") },
      {
        filter: function (t) {
          return o(this, t, arguments.length > 1 ? arguments[1] : void 0);
        },
          ...
          [
            ...
            function (t, o) {
              ...
              for (var b = 0, w = 0, S = []; w < p.length; ) {
                ...
                if (
                  null === O ||
                  ($ = d(s(m.lastIndex + (h ? 0 : w)), p.length)) === b
                )
                  w = u(p, w, g);
                else {
    ...
    r(
      { target: "Array", proto: !0, forced: !f("slice") },
      {
        slice: function (t, n) {
          ...
          if (
            i(d) &&
            ("function" != typeof (e = d.constructor) ||
            ...
            return p.call(d, g, y);
          for (
            r = new (void 0 === e ? Array : e)(v(y - g, 0)), f = 0;
            g < y;
            g++, f++
          )
            g in d && s(r, f, d[g]);
  ...
  function (t, n, e) {
    ...
    jQuery(function (t) {
      ...
      return (function i(c) {
          ...
          if ("undefined" != typeof document) {
            ...
            if ((s(), e)) {
              ...
              i.push(c),
                ...
                localStorage.setItem("expiryList", r(i));
        ...
        function f(t, n) {
          if ("undefined" != typeof document)
            return s(), o(localStorage.getItem(t), n);
        }
        function l(t, e, r) {
          if ("undefined" != typeof document) {
            "number" == typeof (r = n({ path: "/" }, a.defaults, r)).expires &&
        ...
        (a.setStorage = u),
          ...
          (a.set = l),
          (a.getStorage = f),
          (a.showModalNewUser = function (n) {
            f("hadModal") || t(n).modal("show"),
              t(n).on("shown.bs.modal", function () {
                u("hadModal", !0);
              });
          }),
          (a.showModalScoring = function (n, e) {
            ...
            u("Counter", o),
              o >= e && !r && (t(n).modal("show"), u("hasShown", !0));
          }),
          (a.get = function (t) {
            return p(t, !1);
          }),
          ...
          (a.removeStorage = function (t) {
            if ("undefined" != typeof document)
              return s(), localStorage.removeItem(t), t;
          }),
          (a.defaults = {}),
          (a.withConverter = i),
          (window.Cookies = a);
        ...
        (e = [
          {
            key: "init",
            value: function () {
              this.isReplacePrevSet && this.saveOriginalClassList(),
                this.bindMouseEnter(),
                this.bindMouseLeave(),
          ...
          },
          {
            ...
            value: function (t) {
              this.clearRating(),
                this.isReplacePrevSet && this.replacePreviousIcon(t);
              for (var n = 0; n <= t; n++) {
                ...
                (n.textarea = []),
                  ...
                  $(function () {
                    t.$icons.popover({
                      container: t.$rating,
                      content:
                        '<div class="my-0 py-0"> <textarea type="text" style="font-size: 0.78rem" class="md-textarea form-control py-0" placeholder="Write us what can we improve" rows="3"></textarea> <button id="voteSubmitButton" type="submit" class="btn btn-sm btn-primary mt-2">Submit!</button> <button id="closePopoverButton" class="btn btn-flat btn-sm mt-2">Close</button>  </div>',
                    });
                  }),
